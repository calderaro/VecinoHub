    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 px-6 py-6">
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-stone-500">{total} total posts</p>
        </div>
        <Link
          ...
          href={`${adminBasePath}/posts/new`}
          data-testid="admin-posts-add"
        >
          + New Post
        </Link>
      </header>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="relative">
            <select
              ...
              name="status"
              data-testid="admin-posts-status"
              defaultValue={status}
            >
      ...
      <div className="overflow-hidden rounded-xl border border-stone-200 bg-white shadow-sm">
                    ...
                    >
                      <td className="px-5 py-3.5">
                        ...
                        >
                          ...
                          <p className="font-medium text-stone-900 transition-colors group-hover/title:text-teal-700">
                            {post.title}
                          </p>
                        </Link>
                      </td>
        ...
        <div className="flex items-center justify-between border-t border-stone-100 px-5 py-3.5 text-xs text-stone-400">
          <p>{posts.length} of {total} posts</p>
          <div className="flex items-center gap-2">
            {page > 1 ? (
              <Link
                ...
                href={`${adminBasePath}/posts${buildQuery({
                  q: query || undefined,

          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <Link
                ...
                href={`${adminBasePath}/fundraising/${campaign.id}/edit`}
      ...
      <section className="rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-3 flex flex-wrap justify-end gap-2">
          {campaign.status === "open" ? (
            <Link
              ...
              href={`${adminBasePath}/fundraising/${campaign.id}/contribute`}
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.3em] text-stone-500">
          <Link
            ...
            href={`${adminBasePath}/fundraising/${campaign.id}${buildQuery({})}`}
          >
          ...
          <Link
            ...
            href={`${adminBasePath}/fundraising/${campaign.id}${buildQuery({ status: "submitted" })}`}
          >
          ...
          <Link
            ...
            href={`${adminBasePath}/fundraising/${campaign.id}${buildQuery({ status: "confirmed" })}`}
          >
          ...
          <Link
            ...
            href={`${adminBasePath}/fundraising/${campaign.id}${buildQuery({ status: "rejected" })}`}
          >
                ...
                <div>
                  ...
                  <p className="text-xs text-stone-500">
                    ...
                    <Link
                      ...
                      href={`${adminBasePath}/groups/${contribution.groupId}`}
                    >
